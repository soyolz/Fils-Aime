...
export default function Currently() {
    ...
    return (
        <Popover>
            <PopoverButton className="fixed focus:outline-none z-50 h-20 max-w-sm small:translate-y-[40vh] regular:translate-y-[33vh] -translate-x-[18.3vh] font-mono">
        ...
        <PopoverPanel anchor="left"
            ...
            <div className="fixed z-50 h-20 max-w-lg small:w-[38vh] small:translate-y-[47vh] regular:translate-y-[38vh] -translate-x-[18.3vh] font-mono">{renderSelectedUniversity(selectedUniversity)}</div>
        </Popover>
    );
};
