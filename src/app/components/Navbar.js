...
export default function Navbar() {
    return (
        <div className="fixed z-50 h-10 max-w-lg md:translate-y-[14vh] translate-y-[15vh] -translate-x-1/2  bg-white border shadow-md border-gray-200 dark:border-gray-500/25 rounded-full left-1/2 dark:bg-black dark:border-gray-500">
