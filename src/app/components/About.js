...
export default function About() {
    ...
    return (
        ...
        <div className="regular:space-y-3 fixed max-w-lg regular:translate-y-[24vh] extra:translate-y-[22vh] regular:-translate-x-[27vh] extra:-translate-x-[18.3vh] font-mono">
